...
class PurgeObject(object):
    def __init__(self, message=None, limit=100, author=None, contains=None, startsWith=None, endsWith=None, links=None, invites=None, images=None, embeds=None, mentions=None, bots=None, channel=None, files=None, reactions=None, appMessages=None, startDate=None, endDate=None):
