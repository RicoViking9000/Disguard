...
'use_voice_activation': 'Use Voice Activity', 'change_nickname': 'Change Nickname', 'manage_nicknames': 'Manage Nicknames', 'manage_roles': 'Manage Roles', 'manage_webhooks': 'Manage Webhooks',
'manage_emojis': 'Manage Emojis and Stickers', 'use_slash_commands': 'Use Slash Commands', 'request_to_speak': 'Request to Speak in Stage Channel', 'manage_events': 'Manage Server Events',
'manage_threads': 'Manage Threads', 'use_private_threads': 'Use Private Threads'}
...
'stream': 'Members with this permission can stream applications or screenshare in voice channels', 'read_messages': '', 'send_messages': '', 'send_tts_messages': 'Members with this permission can send text-to-speech messages by starting a message with /tts. These messages can be heard by everyone focused on the channel who allow TTS playback in settings',
...
'read_message_history': 'If this permission is disabled, messages in text channels will become invisible to affected members upon disconnecting from that text channel', 'mention_everyone': 'Members with this permission can use @everyone or @here to ping all members with access to the selected channel. They can also @mention all roles, even if that role is not normally mentionable',
'external_emojis': 'Allows members to use emoji from other servers, if they\'re a Discord Nitro member', 'view_guild_insights': 'View Server Insights', 'connect': '', 'speak': '', 'mute_members': '', 'deafen_members': '', 'move_members': 'Members with this permission can move members between voice channels the member with this permission has access to',
'use_voice_activation': 'Members must use Push-To-Talk if this permission is disabled', 'change_nickname': 'Members with this permission can change their own nickname', 'manage_nicknames': 'Members with this permission can set or reset nicknames of all server members',
